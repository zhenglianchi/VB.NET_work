...
Public Class LoginForm
    ...
    Private Sub Login()
        ...
        _rememberedAccount = $"{txtUsername.Text},{txtPassword.Text},{currentAccount.Type}"

        MessageBox.Show($"欢迎登录，{txtUsername.Text}！", "登录成功", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Me.Hide()
